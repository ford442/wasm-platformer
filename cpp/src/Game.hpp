...
public:
    ...
    // NEW: Getter for the camera's position
...
private:
    ...
    Vec2 playerVelocity;
    Vec2 playerSize;
    // NEW: Add a camera position vector
    Vec2 cameraPosition;

    std::vector<Platform> platforms;

    const float gravity = -9.8f * 2.5f;
    const float moveSpeed = 2.0f; // Using your adjusted value
    const float jumpStrength = 6.0f; // Using your adjusted value
